 ...
 */
const std::string CLIENT_NAME("BitcoinC");
...
#ifdef GIT_ARCHIVE
#define GIT_COMMIT_ID "4dc618dc6f3d485ca76e6a8f846e2bdb19c10c36"
#define GIT_COMMIT_DATE "Tue, 25 Jun 2019 23:54:18 -0500"
#endif

#define BUILD_DESC_WITH_SUFFIX(maj, min, rev, suffix) \
    DO_STRINGIZE(maj) "." DO_STRINGIZE(min) "." DO_STRINGIZE(rev) "-" DO_STRINGIZE(suffix)

#define BUILD_DESC_FROM_COMMIT(maj, min, rev, commit) \
    DO_STRINGIZE(maj) "." DO_STRINGIZE(min) "." DO_STRINGIZE(rev) "-g" commit
